...
- Not built yet (in the order of the plan's section 12): CSV export, pause offers and the operating guide for Liliana. Deferred: survey, newsletter, payment gateway, the pre-session form itself (external until the legal texts are signed).
