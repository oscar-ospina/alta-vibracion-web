...
## Booking (epic #31, Phase 1) — build next

Research is done; build the Agenda stories **in order**. The two ADRs in the planner are **load-bearing — read them before coding** ([Google Calendar](https://github.com/oscar-ospina/saas-planner/blob/main/docs/superpowers/specs/2026-06-07-av-google-calendar.md), [backend & data](https://github.com/oscar-ospina/saas-planner/blob/main/docs/superpowers/specs/2026-06-07-av-booking-backend.md)).

**Build order:** [#40](https://github.com/oscar-ospina/saas-planner/issues/40) GCal client (`lib/calendar.ts`) + setup runbook + live smoke-test → [#41](https://github.com/oscar-ospina/saas-planner/issues/41) availability/slots → [#42](https://github.com/oscar-ospina/saas-planner/issues/42) booking page `/agenda` + slot picker → [#43](https://github.com/oscar-ospina/saas-planner/issues/43) booking Server Action → [#44](https://github.com/oscar-ospina/saas-planner/issues/44) confirmation + `.ics`.
